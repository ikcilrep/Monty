...
public enum TokenTypes {
    ...
    ELSE_KEYWORD, END_KEYWORD, FLOAT_LITERAL, FUNC_KEYWORD, IDENTIFIER, IF_KEYWORD, IMPORT_KEYWORD, INTEGER_LITERAL,
    OPERATOR, RETURN_KEYWORD, SEMICOLON, STRING_LITERAL, WHILE_KEYWORD, DOT, DO_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD,
    FOR_KEYWORD, IN_KEYWORD, STRUCT_KEYWORD, FUNCTION, EMPTY_TUPLE, NAMESPACE_KEYWORD,ARROW
}
