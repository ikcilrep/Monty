...
public class ReplaceFirstInList extends FunctionDeclarationNode {
	...
	public ReplaceFirstInList() {
		super("replaceFirstInList", DataTypes.ARRAY);
	...
	public Object call(ArrayList<OperationNode> arguments) {
		...
		return lst.replaceFirst(toBeReplaced, replacement);
	}
